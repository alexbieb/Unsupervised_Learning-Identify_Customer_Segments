# Unsupervised_Learning-Identify_Customer_Segments
Udacity - Data Scientist Nanodegree Program - Unsupervised Learning

**For privacy reason the datasets could not be published or used outside the workspace of the NanoDegree, you will find in this repository the code used to perform the clustering.**
